...
CATALOG = {
    LANG_ZH: {
        ...
        "confirm.ok": "确定",
        "confirm.cancel": "取消",
        "playback.confirm.start": "回到初始状态？当前播放进度会重置。",
        "playback.confirm.end": "跳到结尾？",
        "playback.confirm.back": "返回录入页？",
    ...
    LANG_EN: {
        ...
        "playback.confirm.start": "Back to the start? Playback progress will reset.",
        "playback.confirm.end": "Jump to the end?",
        "playback.confirm.back": "Back to input?",
    ...
    LANG_JA: {
        ...
        "playback.confirm.start": "最初に戻りますか？再生の進捗はリセットされます。",
        "playback.confirm.end": "最後へジャンプしますか？",
        "playback.confirm.back": "入力ページに戻りますか？",
