...
_REF = r"D:\coco\cube-solver\tools\research\5x5\reference"
_REPO = r"D:\coco\cube-solver"
sys.path.insert(0, _REPO)
sys.path.insert(0, _REF)

# terminal_state 在导入时会把 tredge / macro_lib / macro_effect 注册进 sys.modules，
# 因此这里直接 import 即可复用（避免重复构建 REACHABLE）。
import terminal_state as ts  # noqa: E402
import macro_effect as me  # noqa: E402
import macro_lib as ml  # noqa: E402
