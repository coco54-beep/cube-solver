...
_EN = {
    ...
    "顶面全黄后，只需调整四个角块的侧面颜色使其与侧面一致，即完成还原。"
    "多余一个交换相邻两个角块的公式即可。":
    ...
    "使四个角块除了顶面外的另外两面颜色对应中心块颜色，即完成角块归位。":
    ...
    "中心块，这是四阶（每面 2×2 四块、无固定中心）没有的差别。":
    ...
    "五阶每条棱由 1 个中棱 + 2 个翼组成（共 3 块），四阶每条棱只有 2 个翼。"
